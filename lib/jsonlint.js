...
var jsonlint = (function() {
  var parser = {
    ...
    parseError : function parseError(str, hash) { throw new Error(str); },
    parse : function parse(input) {
      ...
      while (true) {
        ...
        _handle_error: if (typeof action === 'undefined' || !action.length ||
          ...
          recovering = 3; // allow 3 real symbols to be shifted before reporting
                          // a new error
        }
        ...
        case 2: // reduce
          ...
          stack.push(
              this.productions_[action[1]][0]); // push nonterminal (reduce)
          vstack.push(yyval.$);
          lstack.push(yyval._$);
  ...
  var lexer = (function() {
    var lexer = ({
      ...
      less : function(n) { this._input = this.match.slice(n) + this._input; },
      pastInput : function() {
        var past =
            this.matched.substr(0, this.matched.length - this.match.length);
      ...
      next : function() {
        ...
        if (match) {
          ...
          this.yylloc = {
            ...
            last_column : lines ? lines[lines.length - 1].length - 1
      ...
      begin : function begin(
          condition) { this.conditionStack.push(condition); },
  ...
  exports.parse = function() {
    ...
    if (typeof process !== 'undefined') {
      var source = require('fs').readFileSync(
          require('path').join(process.cwd(), args[1]), "utf8");
    } else {
    ...
    exports.main(typeof process !== 'undefined' ? process.argv.slice(1)
                                                : require("system").args);
  }
}
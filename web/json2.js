...
if (typeof JSON.stringify !== 'function') {
  JSON.stringify = function(value, replacer, space) {
    ...
    // function that can replace values, or an array of strings that will select
    // the keys. A default replacer method can be provided. Use of the space
...
if (typeof JSON.parse !== 'function') {
  JSON.parse = function(text, reviver) {
    ...
    // mutation. But just to be safe, we want to reject all unexpected forms.
    ...
    // comma or that begin the text. Finally, we look to see that the remaining
    // characters are only whitespace or ']' or
